  ...
  while cap.isOpened():
    ...
    if results.multi_hand_landmarks:
      for hand_landmarks in results.multi_hand_landmarks:
        ...
        elif hand_landmarks.landmark[7].y > hand_landmarks.landmark[8].y and \
                hand_landmarks.landmark[11].y > hand_landmarks.landmark[12].y:
                pydirectinput.keyDown('up')
                pydirectinput.keyUp('up')
        elif hand_landmarks.landmark[8].y > hand_landmarks.landmark[5].y and \
